...
sjcl.bitArray = {
    ...
    $: function (a, b, c, d) {
        ...
        d.push(
            sjcl.bitArray.partial((b + a) & 31, 32 < b + a ? c : d.pop(), 1)
        );
        return d;
    },
    i: function (a, b) {
        ...
        switch (typeof a) {
            ...
            case "object":
                ...
                if (!k) {
                    ...
                    this.c[g].update(
                        [d, this.N++, 2, b, f, a.length].concat(a)
                    );
                }
                break;
            case "string":
...
sjcl.json = {
    ...
    ja: function (a, b, c, d) {
        ...
        "string" === typeof b && (b = sjcl.codec.utf8String.toBits(b));
        "string" === typeof c &&
            (f.adata = c = sjcl.codec.utf8String.toBits(c));
    ...
    ia: function (a, b, c, d) {
        ...
        "string" === typeof a
            ...
            : sjcl.ecc &&
              ...
              (a = a
                  .unkem(sjcl.codec.base64.toBits(b.kemtag))
                  .slice(0, b.ks / 32));
